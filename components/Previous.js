...
const Previous = ({ match }) => {
  return (
    <div className="w-full mx-auto h-[40vh] mt-2 border bg-sky-50 rounded-3xl">
      <div className="bg-blue-500 flex items-center  h-[8vh] shadow-lg">
        <h1 className="text-white font-bold text-5xl px-4">{match.ziua}</h1>
        <div className="flex flex-col px-2 -space-y-2">
          <h1 className="text-white font-medium text-2xl ">
            {match.ziua_saptamanii}
          </h1>
      ...
      <div className="h-[32vh] flex flex-col items-center justify-evenly w-full">
        <div className="flex w-full justify-evenly">
          ...
          <div className="flex justify-center w-1/2">
            <div className="flex justify-center shadow-xl bg-blue-500 py-3 px-5 w-28 rounded-xl  ">
              <h1 className="text-5xl  font-extrabold text-white whitespace-nowrap">
                {match.scor}
              </h1>
            </div>
          </div>
